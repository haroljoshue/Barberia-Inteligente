        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RolSistema = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pregunta = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    Respuesta = table.Column<string>(type: "text", nullable: true),
                    TokensUsados = table.Column<int>(type: "integer", nullable: true),
                    TiempoRespuestaMs = table.Column<int>(type: "integer", nullable: true),
                    MensajeError = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Fecha = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogsAgente", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LogsAgente_AspNetUsers_UsuarioId",
